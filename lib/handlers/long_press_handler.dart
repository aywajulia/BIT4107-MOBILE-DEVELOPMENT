...
/// Location: lib/handlers/long_press_handler.dart
library;
      ...
      builder: (_) => SafeArea(
        child: Column(
          ...
          children: [
            ...
            Text('${meal.calories} kcal', style: const TextStyle(color: Colors.white54, fontSize: 14)),
  ...
  static void _showMealDetailsDialog(BuildContext context, MealEntry meal) {
    showDialog(
      ...
      builder: (_) => AlertDialog(
        ...
        title: Text(meal.name, style: const TextStyle(color: Colors.white, fontWeight: FontWeight.w800)),
        content: Column(
          mainAxisSize: MainAxisSize.min,
          ...
          children: [
            ...
            const Divider(color: Colors.white24),
            if (meal.quantity > 0) _detailRow('Quantity', '${meal.quantity.toStringAsFixed(0)} g'),
            const Divider(color: Colors.white24),
