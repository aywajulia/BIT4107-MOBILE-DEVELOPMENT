...
/// Location: lib/screen/meal_history_screen.dart
library;
                ...
                child: sortedDates.isEmpty
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 16),
                      Text('No meals logged yet.', textAlign: TextAlign.center, style: TextStyle(color: Colors.black45, fontSize: 15, height: 1.5)),
                    ],
                  ),
                )
                    : ListView.builder(
    ...
    return ListTile(
      ...
      trailing: Column(
        ...
        children: [
          ...
          Text(meal.loggedAt.toString().substring(11, 16), style: const TextStyle(fontSize: 10, color: Colors.black38)),
        ],
      ),
    );
  }
